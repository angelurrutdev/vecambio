...
export function PillMount({ id, value, name, title, onClick }: PillMountProps) {
	return (
		<li
			className='
        px-2 cursor-pointer inline-flex items-center space-x-3 justify-center 
        ...
        disabled:opacity-50 dark:focus-visible:ring-neutral-700 focus-visible:ring-neutral-500 
        border border-neutral-200 bg-white shadow-sm hover:bg-neutral-100 
        hover:text-neutral-900 dark:border-neutral-800 dark:bg-neutral-800 
        dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:hover:border-neutral-700/50'
		>
			<input
				type='radio'
				name={name}
